...
<div class="container wow fadeInUp mt-5">
    <div class="text-center mb-5 mx-5 px-5">
        ...
        <h1 class="text-dark  p-3 mt-3 ">Edit Testimonial </h1>
        <hr class="bg-dark">
    </div>
</div>
@stop
...
<div class="container mb-5">
    ...
    <form action="{{route('testimonial.update',$testimonial)}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group text-darka ">
            ...
            <input value="{{$testimonial->prenom}}" type="text" name="prenom"
        ...
        <div class="form-group text-darka ">
            ...
            <input value="{{$testimonial->nom}}" type="text" name="nom"
        ...
        <div class="form-group text-darka ">
            ...
            <input value="{{$testimonial->role}}" type="text" name="role"
        ...
        <div class="form-group text-darka ">
            ...
            <input value="{{$testimonial->company}}" type="text" name="company"
        ...
        <div class="form-group text-darka ">
            ...
            <input value="{{$testimonial->text}}" type="text" name="text"
